...
import { Copy, Share2, File, Download, Info } from "lucide-react";
...
const PublicFileView = () => {
    ...
    useEffect(() => {
        const getFile = async () => {
            setIsLoading(true);
            try {
                const res = await axios.get(api.PUBLIC_FILE_VIEW(fileId));
                setFile(res.data);
                setError(null);
            } catch (err) {
        ...
        <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <main className="container mx-auto p-4 md:p-8 flex justify-center">
                <div className="w-full max-w-3xl">
                    ...
                    <div className="mt-6 bg-blue-50 border border-blue-200 text-blue-800 p-4 rounded-lg flex items-start gap-3">
                        <Info size={20} />
                        <p className="text-sm">
