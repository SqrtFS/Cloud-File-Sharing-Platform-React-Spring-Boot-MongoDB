...
import { UploadCloud, Lock, Share, Wallet, Folder, History } from 'lucide-react';
const iconMap = {
  UploadCloud,
  Lock,
  Share,
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
                        Everything you need to share your cloud resources
                    </h2>
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                        Cloudshare provides all the tools you need to manage your content 
                    </p>
                </div>
